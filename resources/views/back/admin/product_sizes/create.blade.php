...
@section('title', 'Yeni Məhsul Ölçüsü Əlavə Et')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Yeni Məhsul Ölçüsü Əlavə Et</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.product_sizes.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="tab-content p-3 text-muted">
                                ...
                                <div class="tab-pane active" id="az" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('size_name_az') is-invalid @enderror" id="size_name_az" name="size_name_az" value="{{ old('size_name_az') }}" required>
                                        @error('size_name_az')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="tab-pane" id="en" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('size_name_en') is-invalid @enderror" id="size_name_en" name="size_name_en" value="{{ old('size_name_en') }}" required>
                                        @error('size_name_en')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="tab-pane" id="ru" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('size_name_ru') is-invalid @enderror" id="size_name_ru" name="size_name_ru" value="{{ old('size_name_ru') }}" required>
                                        @error('size_name_ru')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('size_value') is-invalid @enderror" id="size_value" name="size_value" value="{{ old('size_value') }}" required>
                                    @error('size_value')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
