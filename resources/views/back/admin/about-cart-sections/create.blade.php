...
@section('title', 'Yeni Haqqımızda Kart Əlavə Et')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Yeni Haqqımızda Kart Əlavə Et</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.about-cart-sections.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
