                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-12">
                                    <a href="{{ route('back.pages.project.create') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        @forelse($projects as $project)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('back.pages.project.toggle-status', $project->id) }}" method="POST" class="d-inline-block">
                                                        @csrf
                                                ...
                                                <td>
                                                    <a href="{{ route('back.pages.project.edit', $project->id) }}" 
                                                       class="btn btn-primary btn-sm">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-danger btn-sm" 
                                                            onclick="deleteData('{{ route('back.pages.project.destroy', $project->id) }}')">
