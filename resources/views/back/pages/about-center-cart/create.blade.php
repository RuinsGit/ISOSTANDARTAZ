                        ...
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="az" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_az') is-invalid @enderror" id="description_az" name="description_az" rows="10">{{ old('description_az') }}</textarea>
                            ...
                            <div class="tab-pane" id="en" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en" rows="10">{{ old('description_en') }}</textarea>
                            ...
                            <div class="tab-pane" id="ru" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_ru') is-invalid @enderror" id="description_ru" name="description_ru" rows="10">{{ old('description_ru') }}</textarea>
