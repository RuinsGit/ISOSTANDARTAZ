@foreach ($products as $product)
    <div class="product-cart">
        <div class="product-cart-top">
            <a href="{{ route('product-detail.' . app()->getLocale(), ['slug' => $product->slug]) }}" class="cart-img">
                <img src="{{ asset($product->poster_image) }}" alt="">
            </a>
            <button class="cart-fav" onclick="add_to_favorite(this)" data-id="{{ $product->id }}" type="button">
                ...
                @else
                    <svg class="added-fav" style="display: block;" width="24" height="24" viewBox="0 0 24 24"
